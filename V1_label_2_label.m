...
setenv('SUBJECTS_DIR','/data/project/vislab/a/HCP_diff_Sara/'); % be sure to edit this to your path

%% cd to subject directory and generate a list of subject names
cd /data/project/vislab/a/HCP_diff_Sara/;
Subs = dir('*MNIfs1mm*'); % change this to a base name that will pull all participants
%
%% Label names
